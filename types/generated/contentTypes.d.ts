...
export interface ApiCategoriaCategoria extends Struct.CollectionTypeSchema {
  ...
  attributes: {
    ...
    posts_blogs: Schema.Attribute.Relation<
      'manyToMany',
      'api::posts-blog.posts-blog'
    >;
    publishedAt: Schema.Attribute.DateTime;
    updatedAt: Schema.Attribute.DateTime;
    updatedBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
...
export interface ApiPostsBlogPostsBlog extends Struct.CollectionTypeSchema {
...
export interface ApiProyectoProyecto extends Struct.CollectionTypeSchema {
  ...
  attributes: {
    ...
    > &
      Schema.Attribute.Private;
    publishedAt: Schema.Attribute.DateTime;
    Tecnologias: Schema.Attribute.Component<'tecnologias.tecnologias', true>;
    Titulo: Schema.Attribute.String;
    updatedAt: Schema.Attribute.DateTime;
    updatedBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
...
declare module '@strapi/strapi' {
  export module Public {
    export interface ContentTypeSchemas {
      ...
      'api::posts-blog.posts-blog': ApiPostsBlogPostsBlog;
